...
$SITE_APIS = [
    ...
    'can-foix' => [
        ...
        'basic_password' => getenv('CANFOIX_BASIC_PASSWORD') ?: 'mywL M8DF sU4H CjnY D23b QssE',
        'categories' => [
            'activitat-de-dia' => 25,
            'centre-interes' => 26,
            'cases-de-colonies' => null,
...
$ACF_FIELD_KEYS = [
    'cases' => [
        ...
        'acces_en_transport_public' => 'acces_en_transport_public',
        'granja_escola' => 'granja_escola',
        'escola_de_mar' => 'escola_de_mar',
        'aventura' => 'aventura',
        'wifi' => 'wifi',
