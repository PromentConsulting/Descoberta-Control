...
$SITE_APIS = [
    'descoberta' => [
        'name' => 'Descoberta',
        'base_url' => getenv('DESCOBERTA_BASE_URL') ?: 'http://descoberta.vl26404.dinaserver.com/',
    ...
    'can-pere' => [
        'name' => 'Can Pere',
        'base_url' => getenv('CANPERE_BASE_URL') ?: 'http://canpere.vl26404.dinaserver.com/',
    ...
    'cal-mata' => [
        'name' => 'Cal Mata',
        'base_url' => getenv('CALMATA_BASE_URL') ?: 'http://escolesdescoberta.vl26404.dinaserver.com/',
    ...
    'can-foix' => [
        'name' => 'Can Foix',
        'base_url' => getenv('CANFOIX_BASE_URL') ?: 'http://canfoixdescoberta.vl26404.dinaserver.com/',
    ...
    'el-ginebro' => [
        'name' => 'El Ginebró',
        'base_url' => getenv('GINEBRO_BASE_URL') ?: 'http://elginebro.vl26404.dinaserver.com/',
